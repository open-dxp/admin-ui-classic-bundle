...
From the OpenDxp project root execute the following commands
...
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-core
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-classic
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-classic-theme-neptune
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-classic-theme-triton
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-ux
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-charts
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-classic-locale
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-font-awesome
npm install --prefix web/bundles/opendxpadmin/js/ -g @sencha/ext-font-ext
```
...
```
bin/ext-gen app --template classicdesktop --classictheme theme-triton --name OpenDxpApp
```
...
```
opendxp-app/build/development/OpenDxpApp/desktop/resources/OpenDxpApp-all*.css
```

Replace the current ones in
```
bundles\AdminBundle\Resources\public\css\ext-js\OpenDxpApp-*.css
```
medi
and adapt the styles as needed (see color map below). Also the resource paths need to be updated.
 ...
 existing `dev/open-dxp/opendxp/bundles/AdminBundle/public/js/ext-js/opendxp*.json` files.
...
[see commit](https://github.com/open-dxp/opendxp/commit/3c641580dbe2efa30e539006ee7166b519ffd832#diff-250264cb98391c6be4d4720f7d887c86)
