...
opendxp.registerNS("opendxp.iconlibrary");
...
opendxp.iconlibrary = {
    ...
    panel: Class.create({
        ...
        activate: function () {
            ...
            tabPanel.setActiveItem("opendxp_iconlibrary_panel");
        },
            ...
            if (!this.panel) {
                const iconLibraryTab = Ext.create('Ext.tab.Panel', {
                    ...
                    items: [
                        {
                            title: t('color_icons'),
                            html: '<iframe src="' + Routing.generate('opendxp_admin_misc_iconlist', {type: 'color'}) + '" frameborder="0" style="width:100%; height:100%" ></iframe>',
                        },
                        {
                            title: t('white_icons'),
                            html: '<iframe src="' + Routing.generate('opendxp_admin_misc_iconlist', {type: 'white'}) + '" frameborder="0" style="width:100%; height:100%" ></iframe>',
                        },
                        {
                            title: t('twemoji'),
                            html: '<iframe src="' + Routing.generate('opendxp_admin_misc_iconlist', {type: 'twemoji'}) + '" frameborder="0" style="width:100%; height:100%" ></iframe>',
                        },
                        {
                            title: t('flags'),
                            html: '<iframe src="' + Routing.generate('opendxp_admin_misc_iconlist', {type: 'flags'}) + '" frameborder="0" style="width:100%; height:100%" ></iframe>',
                        }
                    ]
                });

                this.panel = new Ext.Panel({
                    id: "opendxp_iconlibrary_panel",
                    title: t("icon_library"),
                    iconCls: "opendxp_icon_icons",
                    border: false,
                    layout: 'border',
                    closable: true,
                    items: [
                ...
                this.panel.on("destroy", function () {
                    opendxp.globalmanager.remove("iconlibrary");
                });
    ...
    replaceCurrentTabWithIconLibrary: function () {
        ...
        opendxp.globalmanager.get("layout_toolbar").showIconLibrary()
    },
    ...
    createIconSelectionWidget: function (value,  classId, fieldName = 'icon', width = 396, labelWidth = 200) {
        ...
        const iconStore = new Ext.data.ArrayStore({
            proxy: {
                url: Routing.generate('opendxp_admin_dataobject_class_geticons'),
                type: 'ajax',
                reader: {
                    type: 'json'
                },
