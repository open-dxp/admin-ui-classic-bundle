 ...
 * @private
 */
opendxp.treenodelocator = function()
{
    ...
    var self = {
        ...
        startShowInTree: function(id, elementType) {
            ...
            Ext.Ajax.request({
                url: Routing.generate('opendxp_admin_element_typepath'),
                params: {
                    id: id,
                    type: elementType
                },
                success: function (response) {
                    ...
                    if (res.success) {
                        ...
                        var allLocateConfigs = opendxp.globalmanager.get("tree_locate_configs");
        ...
        processTree: function()
        {
            ...
            var accordion = Ext.getCmp("opendxp_panel_tree_" + locateConfig.side);
            if (accordion) {
                 accordion.expand();
            }
            tree.tree.expand();
        ...
        addLoadingIndicator: function (type, id) {
            ...
            opendxp.helpers.addTreeNodeLoadingIndicator(type, id);
        },
        ...
        clearLoadingIndicators: function () {
            for (var i=0; i<loadingIndicators.length; i++) {
                opendxp.helpers.removeTreeNodeLoadingIndicator(loadingIndicators[i].type, loadingIndicators[i].id);
            }
            loadingIndicators = [];
        }
