...
opendxp.registerNS("opendxp.settings.translation.translationSettingsTab");
/**
 * @private
 */
opendxp.settings.translation.translationSettingsTab = Class.create({
    ...
    getPanel: function () {
        ...
        if (!this.csvSettingsForm) {
            this.settingsForm = new Ext.form.FormPanel({
                ...
                iconCls: 'opendxp_icon_file_types',
                defaults: {
                    labelWidth: 150,
                    width: 400
                },
    ...
    updateColumnConfig: function (isReload, dialect) {
        Ext.Ajax.request({
            url: Routing.generate('opendxp_admin_dataobject_dataobjecthelper_importgetfileinfo'),
            params: {
