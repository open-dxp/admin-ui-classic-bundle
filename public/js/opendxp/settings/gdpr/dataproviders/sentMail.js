...
opendxp.registerNS("opendxp.settings.gdpr.dataproviders.sentMail");
/**
 * @private
 */
opendxp.settings.gdpr.dataproviders.sentMail = Class.create({
    ...
    getPanel: function () {
        ...
        if(!this.panel) {
            ...
            this.panel = new Ext.Panel({
                ...
                layout: "border",
                iconCls: "opendxp_icon_email opendxp_icon_overlay_go",
                closable: false,
                items: [
                    this.getGrid()
                ]
                ...
                items : [{
                    ...
                    handler: function(grid, rowIndex){
                        if (!user.isAllowed("emails")) {
                            opendxp.helpers.showPermissionError("emails");
                            return;
                        }
                                    ...
                                    renderer: function(value, metadata, record) {
                                        ...
                                        if (data.type == 'simple') {
                                            ...
                                            if (data.objectPath) {
                                                ...
                                                return '<span onclick="opendxp.helpers.open'
                ...
                items: [
                    {
                        ...
                        handler: function (grid, rowIndex) {
                            ...
                            opendxp.helpers.download(Routing.generate('opendxp_admin_gdpr_sentmail_exportdataobject', {id: data.data.id}));
                        }.bind(this),
                        getClass: function(v, meta, rec) {
                            if (!user.isAllowed("emails")) {
                                return "inactive_actioncolumn";
