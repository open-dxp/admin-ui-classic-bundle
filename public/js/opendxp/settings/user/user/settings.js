...
opendxp.registerNS("opendxp.settings.user.user.settings");
/**
 * @private
 */
opendxp.settings.user.user.settings = Class.create({
    ...
    getPanel: function () {
        ...
        generalItems.push({
            ...
            items: [{
                ...
                handler: function () {
                    Ext.Ajax.request({
                        url: Routing.generate('opendxp_admin_user_reset2fasecret'),
                        method: 'PUT',
                        params: {
            ...
            items: [
                {
                    ...
                    items: [{
                        xtype: "image",
                        id: "opendxp_user_image_" + this.currentUser.id,
                        src: Routing.generate(
                            'opendxp_admin_user_getimage',
                ...
                },
                {
                    ...
                    handler: function () {
                        opendxp.helpers.uploadDialog(
                            Routing.generate('opendxp_admin_user_uploadimage', {id: this.currentUser.id}),
                            null,
                            function () {
                                Ext.getCmp("opendxp_user_delete_image_" + this.currentUser.id).setVisible(true);
                ...
                },
                {
                    ...
                    tooltip: t("remove"),
                    id: "opendxp_user_delete_image_" + this.currentUser.id,
                    ...
                    handler: function () {
                        Ext.Ajax.request({
                            ...
                            method: 'DELETE',
                            success: function() {
                                Ext.getCmp("opendxp_user_delete_image_" + this.currentUser.id).setVisible(false);
                                opendxp.helpers.reloadUserImage(this.currentUser.id);
            ...
            items: [emailField,
                {
                    ...
                    handler: function () {
                        Ext.Ajax.request({
                            url: Routing.generate('opendxp_admin_user_invitationlink'),
                            method: 'POST',
                            ignoreErrors: true,
                            params: {
        ...
        adminItems.push({
            ...
            handler: function () {
                Ext.Ajax.request({
                    url: Routing.generate('opendxp_admin_user_gettokenloginlink'),
                    ignoreErrors: true,
                    params: {
                        id: this.currentUser.id
                    },
                    success: function (response) {
                        ...
                        if (res["link"]) {
                            Ext.MessageBox.show({
                                ...
                                fn: function (result) {
                                    if (result === 'yes') {
                                        opendxp.helpers.copyStringToClipboard(res["link"]);
                                    }
                                }
                            });
                        }
        ...
        this.typesSet = new Ext.form.FieldSet({
            ...
            items: [
                Ext.create('Ext.ux.form.MultiSelect', {
                    ...
                    width: 400,
                    valueField: "id",
                    store: opendxp.globalmanager.get("document_types_store"),
        ...
        this.editorSettings = new opendxp.settings.user.editorSettings(this, this.data.user.contentLanguages);
        this.websiteTranslationSettings = new opendxp.settings.user.websiteTranslationSettings(this, this.data.validLanguages, this.data.user);
    ...
    getValues: function () {
        ...
        if (values["password"]) {
            if (!opendxp.helpers.isValidPassword(values["password"])) {
