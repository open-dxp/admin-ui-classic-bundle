...
opendxp.registerNS("opendxp.settings.user.workspace.object");
/**
 * @private
 */
opendxp.settings.user.workspace.object = Class.create({
        ...
        typesColumns.push({
            ...
            items: [{
                ...
                handler: function (grid, rowIndex) {
                    ...
                    var dialog = new opendxp.settings.user.workspace.special(callback, specialData, data.data.path);
                    dialog.show();
                }.bind(this)
            }]
        });
