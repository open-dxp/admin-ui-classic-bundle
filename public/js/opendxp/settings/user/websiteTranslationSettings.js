...
opendxp.registerNS("opendxp.settings.user.websiteTranslationSettings");
/**
 * @private
 */
opendxp.settings.user.websiteTranslationSettings = Class.create({
    ...
    getPanel:function () {
        ...
        for (var i = 0; i < nrOfLanguages; i++) {
            ...
            data.push([
                language,
                t(opendxp.available_languages[language]),
