...
opendxp.registerNS("opendxp.settings.user.role.settings");
/**
 * @private
 */
opendxp.settings.user.role.settings = Class.create({
    ...
    getPanel: function () {
        ...
        this.websiteTranslationSettings = new opendxp.settings.user.websiteTranslationSettings(this, this.data.validLanguages, this.data.role);
