...
opendxp.registerNS("opendxp.settings.document.doctypes");
/**
 * @private
 */
opendxp.settings.document.doctypes = Class.create({
    ...
    activate: function () {
        ...
        tabPanel.setActiveItem("opendxp_document_types");
    },
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            this.panel = new Ext.Panel({
                id: "opendxp_document_types",
                title: t("document_types"),
                iconCls: "opendxp_icon_doctypes",
                border: false,
                layout: "fit",
                closable: true,
            ...
            this.panel.on("destroy", function () {
                opendxp.globalmanager.remove("document_types");
            }.bind(this));
    ...
    getRowEditor: function () {
        ...
        this.store = opendxp.globalmanager.get("document_types_store");
            ...
            },
            {
                ...
                editor: new Ext.form.ComboBox({
                    store: new Ext.data.Store({
                        ...
                        proxy: {
                            type: 'ajax',
                            url: Routing.generate('opendxp_admin_misc_getavailabletemplates'),
                            reader: {
                                type: 'json',
                                rootProperty: 'data'
                            }
            ...
            },
            {
                ...
                items: [{
                    ...
                    handler: function (grid, rowIndex) {
                        ...
                        opendxp.helpers.deleteConfirm(t('document_type'),
                ...
                items: [
                    {
                        ...
                        disabled: !opendxp.settings['document-types-writeable']
                    }
                ]
            },
            viewConfig: {
        ...
        const prepareDocumentTypesGrid = new CustomEvent(opendxp.events.prepareDocumentTypesGrid, {
            detail: {
                grid: this.grid,
                object: this
            }
    ...
    getPredefinedDocumentTypes: function () {
        ...
        for (const [key, value] of Object.entries(opendxp.settings.document_types_configuration)) {
