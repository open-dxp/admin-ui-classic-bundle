...
opendxp.registerNS("opendxp.settings.website");
/**
 * @private
 */
opendxp.settings.website = Class.create({
    ...
    activate:function () {
        ...
        tabPanel.setActiveItem("opendxp_website_settings");
    },
    ...
    getTabPanel:function () {
        ...
        if (!this.panel) {
            this.panel = new Ext.Panel({
                id:"opendxp_website_settings",
                title: t('website_settings'),
                iconCls: "opendxp_icon_website_settings",
                border:false,
                layout:"fit",
                closable:true,
            ...
            this.panel.on("destroy", function () {
                opendxp.globalmanager.remove("settings_website");
            }.bind(this));
    ...
    getRowEditor:function () {
        ...
        var url = Routing.generate('opendxp_admin_settings_websitesettings');
        ...
        let websiteLanguages = opendxp.settings.websiteLanguages;
        let selectContent = "";
        ...
        var typesColumns = [
            ...
            },
            {
                ...
                width:40,
                tooltip:t('empty'),
                icon: "/bundles/opendxpadmin/img/flat-color-icons/full_trash.svg",
            ...
            },
            {
                ...
                handler:function (grid, rowIndex) {
                    ...
                    opendxp.helpers.deleteConfirm(t('website_settings'), Ext.util.Format.htmlEncode(data.data.name), function () {
    ...
    getTypeRenderer: function (value, metaData, record, rowIndex, colIndex, store) {
        ...
        return '<div class="opendxp_icon_' + value + '" data-id="' + record.get("id") + '">&nbsp;</div>';
    },
