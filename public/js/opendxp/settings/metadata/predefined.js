...
opendxp.registerNS("opendxp.settings.metadata.predefined");
/**
 * @private
 */
opendxp.settings.metadata.predefined = Class.create({
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            ...
            this.panel.on("destroy", function () {
                opendxp.globalmanager.remove("predefined_metadata");
            }.bind(this));
    ...
    getRowEditor: function () {
        var url = Routing.generate('opendxp_admin_settings_metadata');
        ...
        for (let i=0; i<opendxp.settings.websiteLanguages.length; i++) {
            languagestore.push([opendxp.settings.websiteLanguages[i],opendxp.settings.websiteLanguages[i]]);
        }

        var supportedTypes = opendxp.helpers.getAssetMetadataDataTypes("predefined");
        var typeStore = [];
            ...
            },
            {
                ...
                items: [{
                    ...
                    handler: function (grid, rowIndex) {
                        ...
                        opendxp.helpers.deleteConfirm(t('predefined_metadata'),
            ...
            listeners: {
                ...
                validateedit: function (editor, context, eOpts) {
                    if (!context.record.data.writeable) {
                        editor.cancelEdit();
                        opendxp.helpers.showNotification(t("info"), t("config_not_writeable"), "info");
                        return false;
                    }
                }
            }
                ...
                items: [
                    {
                        ...
                        disabled: !opendxp.settings['predefined-asset-metadata-writeable']
                    },"->",{
    ...
    getTypeRenderer: function (value, metaData, record, rowIndex, colIndex, store) {
        ...
        return '<div class="opendxp_icon_' + value + '" recordid=' + record.id + '>&nbsp;</div>';
    },
    ...
    getCellEditor: function (record) {
        ...
        var type = data.type;
        var editor = opendxp.asset.metadata.tags[type].prototype.getGridCellEditor("predefined", record);
        return editor;
    }
});
