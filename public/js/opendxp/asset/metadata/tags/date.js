...
opendxp.registerNS("opendxp.asset.metadata.tags.date");
/**
 * @private
 */
opendxp.asset.metadata.tags.date = Class.create(opendxp.asset.metadata.tags.abstract, {
    ...
    getGridCellRenderer: function(value, metaData, record, rowIndex, colIndex, store) {
        if (value) {
            ...
            return Ext.Date.format(value, opendxp.globalmanager.get('localeDateTime').getShortDateFormat());
        }
