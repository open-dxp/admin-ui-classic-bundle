...
opendxp.registerNS("opendxp.asset.metadata.tags.manyToOneRelation");
/**
 * @private
 */
opendxp.asset.metadata.tags.manyToOneRelation = Class.create(opendxp.asset.metadata.tags.abstract, {
    ...
    getLayoutEdit: function () {
        ...
        href.editable = false;
        href.fieldCls = "opendxp_droptarget_input";
    ...
    getOpenActionItem: function() {
        return {
            ...
            handler: function (grid, rowIndex) {
                ...
                if (pData.data) {
                    opendxp.helpers.openElement(pData.data, pData.type);
                }
            }.bind(this),
        };
    },
