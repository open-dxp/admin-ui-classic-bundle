...
opendxp.registerNS("opendxp.asset.versions");
/**
 * @private
 */
opendxp.asset.versions = Class.create({
    ...
    getLayout: function () {
        ...
        if (this.layout == null) {
            ...
            var modelName = 'opendxp.model.assetversions';
    ...
    onRowClick: function(grid, record, tr, rowIndex, e, eOpts ) {
        ...
        var url = Routing.generate('opendxp_admin_asset_showversion', {
            id: versionId,
    ...
    publishVersion: function (index, grid) {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_admin_asset_publishversion'),
            method: 'post',
            params: {id: versionId},
            success: function(response) {
                ...
                if (rdata.success) {
                    this.asset.reload();
                    opendxp.helpers.updateTreeElementStyle('asset', this.asset.id, rdata.treeData);
                } else {
