...
opendxp.registerNS("opendxp.asset.archive");
/**
 * @private
 */
opendxp.asset.archive = Class.create(opendxp.asset.asset, {
    ...
    initialize: function(id, options) {
        ...
        const preOpenAssetArchive = new CustomEvent(opendxp.events.preOpenAsset, {
            detail: {
                object: this,
                type: "archive"
            },
