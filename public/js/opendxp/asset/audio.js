...
opendxp.registerNS("opendxp.asset.audio");
/**
 * @private
 */
opendxp.asset.audio = Class.create(opendxp.asset.asset, {
    ...
    initialize: function(id, options) {
        ...
        const preOpenAssetAudio = new CustomEvent(opendxp.events.preOpenAsset, {
            detail: {
                object: this,
                type: "audio"
            },
