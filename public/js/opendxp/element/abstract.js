...
opendxp.registerNS("opendxp.element.abstract");
/**
 * @private
 */
opendxp.element.abstract = Class.create({
    ...
    addLoadingPanel: function () {
        var type = opendxp.helpers.getElementTypeByObject(this);
        opendxp.helpers.addTreeNodeLoadingIndicator(type, this.id);
    },

    removeLoadingPanel: function () {
        var type = opendxp.helpers.getElementTypeByObject(this);
        opendxp.helpers.removeTreeNodeLoadingIndicator(type, this.id);
    },
    ...
    setupChangeDetector: function () {
         ...
         */
        this._allowDirtyClose = opendxp.globalmanager.get("user").allowDirtyClose;
    ...
    getAutoSaveIntervalTime: function () {
        return opendxp.settings[opendxp.helpers.getElementTypeByObject(this) + '_auto_save_interval'];
    },
        ...
        return [
            {
                ...
                handler: opendxp.helpers.copyStringToClipboard.bind(this, metainfo.id)
            },
            {
                text: t("metainfo_copy_fullpath"),
                iconCls: "opendxp_icon_copy",
                handler: opendxp.helpers.copyStringToClipboard.bind(this, metainfo.path)
            },
            {
                text: t("metainfo_copy_deeplink"),
                iconCls: "opendxp_icon_copy",
                handler: opendxp.helpers.copyStringToClipboard.bind(this, metainfo.deeplink)
            }
        ];
    },
    ...
    getIconClass: function () {
        ...
        if (this.data.iconCls) {
            ...
            iconClass = opendxp.helpers.getClassForIcon(this.data.icon);
        }
        return iconClass;
    },
    ...
    deleteDraft : function () {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_admin_element_deletedraft'),
            method: 'DELETE',
            params: {
