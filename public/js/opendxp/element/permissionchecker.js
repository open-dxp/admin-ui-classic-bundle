...
opendxp.registerNS("opendxp.element.permissionchecker");
/**
 * @private
 */
opendxp.element.permissionchecker = Class.create({
            ...
            this.analyzeButton = new Ext.Button(
                {
                    ...
                    listeners: {
                        "click": function () {
                            Ext.Ajax.request({
                                url: Routing.generate('opendxp_admin_element_analyzepermissions'),
                                method: "post",
                                params: {
                                    userId: this.userId,
        ...
        for (var i = 0; i < columnCount; i++) {
            ...
            var columnConfig = {
                ...
                renderer: function (columnName, value, metaData, record) {
                    if (value === true) {
                        metaData.tdCls += " opendxp_icon_success";
                    } else {
                        metaData.tdCls += " opendxp_icon_cancel";
                    }
            ...
            columns: [{
            ...
            },
                {
                    ...
                    renderer: function (value, metaData, record) {
                        if (value === true) {
                            return '<div class="opendxp_icon_success" style="min-width: 50px;">&nbsp;</div>';
                        } else if (value === false) {
                            return '<div class="opendxp_icon_cancel" style="min-width: 50px;">&nbsp;</div>';
                        }
                    }.bind(this)
                },
                {
                    ...
                    renderer: function (value, metaData, record) {
                        if (record.data.c == "user") {
                            return '<div class="opendxp_icon_user" style="min-width: 50px;">&nbsp;</div>';
                        } else if (record.data.c == "role") {
                            return '<div class="opendxp_icon_roles" style="min-width: 50px;">&nbsp;</div>';
                        }
                    }.bind(this)
                },
                {
