...
opendxp.registerNS("opendxp.element.tag.imagecropper");
/**
 * @private
 */
opendxp.element.tag.imagecropper = Class.create({
    ...
    open: function (modal) {
        var validImage = (typeof this.imageId != "undefined" && this.imageId !== null),
            imageUrl = Routing.generate('opendxp_admin_asset_getimagethumbnail', {id: this.imageId, width: 500, height: 400, contain: true}),
            button = {};
