...
opendxp.registerNS("opendxp.element.tag.assignment");
/**
 * @private
 */
opendxp.element.tag.assignment = Class.create({
    ...
    getLayout: function () {
        ...
        if (this.layout == null) {
            ...
            var gridStore = Ext.create("Ext.data.Store", {
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_admin_tags_loadtagsforelement'),
                    extraParams: {
            ...
            tree.setCheckChangeCallback(function(gridStore, node, checked) {
                ...
                if(checked) {
                    ...
                    Ext.Ajax.request({
                        url: Routing.generate('opendxp_admin_tags_addtagtoelement'),
                        method: 'PUT',
                        params: {
            ...
            this.layout = Ext.create("Ext.Panel", {
                ...
                region: "center",
                iconCls: "opendxp_material_icon_tags opendxp_material_icon",
                layout: 'border',
    ...
    removeTagFromElement: function(tagId) {
        Ext.Ajax.request({
            url: Routing.generate('opendxp_admin_tags_removetagfromelement'),
            method: 'DELETE',
            params: {
                assignmentElementId: this.element.id,
                assignmentElementType: this.elementType,
    ...
    prepareBatchUpdate: function(removeAndApply) {
        Ext.Ajax.request({
            url: Routing.generate('opendxp_admin_tags_getbatchassignmentjobs'),
            params: {
            ...
            success: function(response) {
                ...
                if(responseJson.totalCount == 0) {
                    ...
                    for (var i=0; i<responseJson.idLists.length; i++) {
                        jobs.push({
                            url: Routing.generate('opendxp_admin_tags_dobatchassignment'),
                            method: 'PUT',
