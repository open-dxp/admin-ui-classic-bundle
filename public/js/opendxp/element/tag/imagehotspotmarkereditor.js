...
opendxp.registerNS("opendxp.element.tag.imagehotspotmarkereditor");
/**
 * @private
 */
opendxp.element.tag.imagehotspotmarkereditor = Class.create({
    ...
    open: function (modal) {
        var validImage = (typeof this.imageId != "undefined" && this.imageId !== null),
            imageUrl = Routing.generate('opendxp_admin_asset_getimagethumbnail', {id: this.imageId, width: this.width, height: this.height, contain: true});
        ...
        var markerConfig = this.getButtonConfig("marker", "opendxp_icon_overlay_add");
        var hotspotConfig = this.getButtonConfig("hotspot", "opendxp_icon_image_region opendxp_icon_overlay_add");
        ...
        this.hotspotWindow = new Ext.Window({
            ...
            autoDestroy: true,
            resizable: false,
            bodyStyle: "background: url('/bundles/opendxpadmin/img/tree-preview-transparent-background.png');",
            tbar: {
    ...
    addMarker: function (config) {
        ...
        this.hotspotWindow.body.getFirstChild().insertHtml("beforeEnd", '<div id="' + markerId
            + '" class="opendxp_image_marker"></div>');
    ...
    addMarkerHotspotContextMenu: function (id, type, el) {
        el.on("contextmenu", function (id, e) {
            ...
            menu.add(new Ext.menu.Item({
                text: t("add_data"),
                iconCls: "opendxp_icon_metadata opendxp_icon_overlay_add",
    ...
    editMarkerHotspotData: function (id) {
        ...
        var hotspotMetaDataWin = new Ext.Window({
            ...
            tbar: [{
                ...
                menu: [{
                    text: t("textfield"),
                    iconCls: "opendxp_icon_input",
                    handler: function () {
                        addItem("textfield");
                    }
                }, {
                    text: t("textarea"),
                    iconCls: "opendxp_icon_textarea",
                    handler: function () {
                        addItem("textarea");
                    }
                }, {
    ...
    openSearchEditor: function (textfield, type, hotspotMetaDataWin, nameField) {
        ...
        opendxp.helpers.itemselector(false, this.addDataFromSelector.bind(this, textfield), {
                type: allowedTypes,
                ...
                menu.push(
                    {
                        ...
                        iconCls: "opendxp_icon_hotspotmarker_template",
