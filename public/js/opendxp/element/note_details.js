...
opendxp.registerNS("opendxp.element.note_details");
/**
 * @private
 */
opendxp.element.note_details = Class.create({
    getClassName: function (){
        return "opendxp.element.note_details";
    },
        ...
        items.push(
            {
                ...
                fieldLabel: t('date'),
                readOnly: true,
                value: Ext.Date.format(date, opendxp.globalmanager.get('localeDateTime').getDateTimeFormat())
            }
        );
