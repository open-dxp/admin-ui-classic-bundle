...
opendxp.registerNS("opendxp.workflowmanagement.actionPanel");
/**
 * @private
 */
opendxp.workflowmanagement.actionPanel = Class.create({

    getClassName: function ()
    {
        return "opendxp.workflowmanagement.actionPanel";
    },
        ...
        Ext.each(additional, function(c) {
            ...
            if (in_array(c.fieldType, supportedTags)) {
                ...
                try {
                    ...
                    //create new opendxp tag field
                    var tag = new opendxp.object.tags[c.fieldType](null, c);
    ...
    submitWorkflowTransition: function()
    {
        ...
        //send a request to the server with the current form data
        Ext.Ajax.request({
            url : Routing.generate('opendxp_admin_workflow_submitworkflowtransition'),
            method: 'post',
            params: formvars,
