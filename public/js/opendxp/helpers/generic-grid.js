...
opendxp.helpers.grid.buildDefaultPagingToolbar = function (store, options) {
    var config = {
...
opendxp.helpers.grid.getTranslationColumnRenderer = function (value, metaData, record, rowIndex, colIndex, store) {
