...
opendxp.registerNS("opendxp.document.settings_abstract");
/**
 * @private
 */
opendxp.document.settings_abstract = Class.create({
                ...
                },
                {
                    ...
                    items: ["->", {
                            ...
                            Ext.MessageBox.confirm(t("are_you_sure"), t("all_content_will_be_lost"),
                                function (buttonValue) {
                                    if (buttonValue == "yes") {
                                        ...
                                        Ext.Ajax.request({
                                            url:Routing.generate('opendxp_admin_document_page_changemaindocument'),
                                            method: 'PUT',
                                            params:{
                                                id: this.document.id,
                        ...
                        handler: function () {
                            ...
                            opendxp.helpers.openDocumentByPath(mainPath);
                        }.bind(this)
                    },{
                        text:t("apply"),
    ...
    getControllerViewFields: function (collapsed) {
        ...
        var docTypeStore = new Ext.data.Store({
            proxy: {
                url: Routing.generate('opendxp_admin_document_document_getdoctypes', {type: this.document.getType()}),
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        var fieldSet = new Ext.form.FieldSet({
            ...
            id: "opendxp_document_settings_" + this.document.id,
            collapsible: true,
            collapsed: collapsed,
            autoHeight:true,
            defaultType: 'textfield',
            ...
            defaults: {
                ...
                listeners: {
                    "change": function (field, checked) {
                        Ext.getCmp("opendxp_document_settings_" + this.document.id).dirty = true;
                    }.bind(this)
                },
            }
    ...
    getStaticGeneratorFields: function (collapsed) {
        ...
        if (this.document.data.staticLastGenerated) {
            ...
            lastGenerated = Ext.Date.format(date, opendxp.globalmanager.get('localeDateTime').getShortDateTimeFormat());
        }else{
