...
opendxp.registerNS("opendxp.document.folder");
/**
 * @private
 */
opendxp.document.folder = Class.create(opendxp.document.document, {
    ...
    initialize: function(id, options) {
        ...
        const preOpenDocumentFolder = new CustomEvent(opendxp.events.preOpenDocument, {
            detail: {
                document: this,
                type: "folder"
            },
    ...
    addTab: function () {
        ...
        this.tab.on("destroy", function () {
            ...
            opendxp.helpers.forgetOpenTab("document_" + this.id + "_folder");
        }.bind(this));
        ...
        this.tab.on("afterrender", function (tabId) {
            ...
            const postOpenDocumentFolder = new CustomEvent(opendxp.events.postOpenDocument, {
                detail: {
                    document: this,
                    type: "folder"
                }
