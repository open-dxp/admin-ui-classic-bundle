...
opendxp.registerNS("opendxp.document.properties");
/**
 * @private
 */
opendxp.document.properties = Class.create(opendxp.element.properties, {
    ...
    getLayout: function ($super) {
        ...
        if (!this.layout) {
            ...
            var setLanguageIcon = function (select) {
                ...
                if (select.getValue()) {
                    classNames += " opendxp_icon_language_" + select.getValue().toLowerCase();
                    classNames += " opendxp_document_property_language_label";
                }
