...
opendxp.registerNS("opendxp.document.hardlink");
/**
 * @private
 */
opendxp.document.hardlink = Class.create(opendxp.document.document, {
    ...
    addTab: function () {
        ...
        this.tab.on("destroy", function () {
            ...
            opendxp.helpers.forgetOpenTab("document_" + this.id + "_hardlink");
        }.bind(this));
                    ...
                    menu.add(new Ext.menu.Item({
                        ...
                        handler: function (item) {
                            ...
                            if (pathField.getValue()) {
                                opendxp.helpers.openElement(pathField.getValue(), 'document');
                            }
                        }.bind(this)
                    }));
