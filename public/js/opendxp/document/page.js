...
opendxp.registerNS("opendxp.document.page");
/**
 * @private
 */
opendxp.document.page = Class.create(opendxp.document.page_snippet, {
    ...
    initialize: function(id, options) {
        ...
        const preOpenDocumentPage = new CustomEvent(opendxp.events.preOpenDocument, {
            detail: {
                document: this,
                type: "page"
            },
    ...
    init: function () {
        ...
        if (this.isAllowed("settings")) {
            this.settings = new opendxp.document.pages.settings(this);
        ...
        if(opendxp.globalmanager.get('customReportsPanelImplementationFactory').hasImplementation()) {
            this.reports = opendxp.globalmanager.get('customReportsPanelImplementationFactory').getNewReportInstance("document_page");
        }
    ...
    getTabPanel: function () {
        ...
        this.tabbar = opendxp.helpers.getTabBar({items: items, tabBar: {tabConfig: {margin: 0}}});
        return this.tabbar;
    },
