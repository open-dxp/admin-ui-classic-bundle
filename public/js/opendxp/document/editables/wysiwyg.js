...
opendxp.registerNS("opendxp.document.editables.wysiwyg");
/**
 * @private
 */
opendxp.document.editables.wysiwyg = Class.create(opendxp.document.editable, {
    ...
    render: function () {
        ...
        Ext.get(this.id).insertHtml("beforeEnd",'<div class="opendxp_editable_droptarget"></div>');
        ...
        Ext.get(this.textarea).addCls("opendxp_wysiwyg");
