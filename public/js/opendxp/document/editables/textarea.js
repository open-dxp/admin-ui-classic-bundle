...
opendxp.registerNS("opendxp.document.editables.textarea");
/**
 * @private
 */
opendxp.document.editables.textarea = Class.create(opendxp.document.editable, {
    ...
    render: function () {
        ...
        this.element.dom.addEventListener("paste", function(e) {
            ...
            try {
                opendxp.edithelpers.pasteHtmlAtCaret(text);
            } catch (e) {
                console.log(e);
            }
        }.bind(this));
