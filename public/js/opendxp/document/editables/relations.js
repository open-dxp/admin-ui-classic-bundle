...
opendxp.registerNS("opendxp.document.editables.relations");
/**
 * @private
 */
opendxp.document.editables.relations = Class.create(opendxp.document.editable, {
    ...
    onNodeDrop: function (target, dd, e, data) {
        ...
        data.records.forEach(function (record) {
            if (!this.dndAllowed(this.getCustomOpenDxpDropData(record))) {
                return false;
            }
    ...
    onRowContextmenu: function (grid, record, tr, rowIndex, e, eOpts) {
        ...
        menu.add(new Ext.menu.Item({
            ...
            handler: function (record, item) {
                ...
                opendxp.helpers.openElement(record.data.id, record.data.type, subtype);
            }.bind(this, record)
        }));
        ...
        if (opendxp.elementservice.showLocateInTreeButton("document")) {
            menu.add(new Ext.menu.Item({
                ...
                handler: function (item) {
                    item.parentMenu.destroy();
                    opendxp.treenodelocator.showInTree(record.data.id, record.data.type);
                }.bind(this)
            }));
        }
