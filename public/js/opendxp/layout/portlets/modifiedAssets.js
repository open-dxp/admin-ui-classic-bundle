...
opendxp.registerNS("opendxp.layout.portlets.modifiedAssets");
/**
 * @private
 */
opendxp.layout.portlets.modifiedAssets = Class.create(opendxp.layout.portlets.abstract, {

    getType: function () {
        return "opendxp.layout.portlets.modifiedAssets";
    },
    ...
    getLayout: function (portletId) {
        ...
        var store = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_admin_portal_portletmodifiedassets'),
                reader: {
                    type: 'json',
                    rootProperty: 'assets'
                }
        ...
        grid.on("rowclick", function(grid, record, tr, rowIndex, e, eOpts ) {
            ...
            opendxp.helpers.openAsset(data.data.id, data.data.type);
        });
