...
opendxp.registerNS("opendxp.object.bulkimport");
/**
 * @private
 */
opendxp.object.bulkimport = Class.create(opendxp.object.bulkbase, {
    initialize: function () {
    },

    getUploadUrl: function(){
        return Routing.generate('opendxp_admin_dataobject_class_bulkimport');
    },

    upload: function() {

        opendxp.helpers.uploadDialog(this.getUploadUrl(), "Filedata", function(response) {
    ...
    commitData: function(idx) {
        if (idx < this.values.length) {
            ...
            Ext.Ajax.request({
                url: Routing.generate('opendxp_admin_dataobject_class_bulkcommit'),
                method: "post",
                params: {
                ...
                success: function(transport){
                    ...
                    if (data.success) {
                        ...
                        if (idx < this.values.length) {
                            ...
                            opendxp.helpers.showNotification(t("success"), t("definitions_saved"));
                        }
                    } else {
                        opendxp.helpers.showNotification(t("error"), t("saving_failed") + " " + this.values[idx].displayName);
                    }
