...
opendxp.registerNS("opendxp.object.fieldlookup.helper");
/**
 * @private
 */
opendxp.object.fieldlookup.helper = Class.create(opendxp.object.helpers.classTree, {
        ...
        for(let i = 0; i < keys.length; i++) {
            if (data[keys[i]]) {
                ...
                if (dataEntry.children) {
                    ...
                    var baseNode = {
                        type: "layout",
                        iconCls: "opendxp_icon_" + dataEntry.nodeType,
                        text: text,
                        originalText: text
                    };
