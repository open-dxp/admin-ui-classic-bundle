...
opendxp.registerNS("opendxp.object.fieldlookup.filterdialog");
/**
 * @private
 */
opendxp.object.fieldlookup.filterdialog = Class.create({
    ...
    getFilterPanel: function () {
        ...
        if (!this.filterPanel) {
            ...
            for (var i = 0; i < opendxp.settings.websiteLanguages.length; i++) {
                if (i == 0) {
                    value = opendxp.settings.websiteLanguages[0];
                }
    ...
    getClassTree: function (url, id) {
        ...
        var classTreeHelper = new opendxp.object.fieldlookup.helper(true, {}, this.object);
    ...
    updatePreview: function () {
        ...
        if (!language && opendxp.settings.websiteLanguages && opendxp.settings.websiteLanguages.length > 0) {
            language = opendxp.settings.websiteLanguages[0];
        }
        ...
        if (record.data.dataType == "system") {
            ...
            var tag = new opendxp.object.tags[dataType](data, layout);
