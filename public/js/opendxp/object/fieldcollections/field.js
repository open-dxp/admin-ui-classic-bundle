...
opendxp.registerNS("opendxp.object.fieldcollections.field");
/**
 * @private
 */
opendxp.object.fieldcollections.field = Class.create(opendxp.object.classes.klass, {
    ...
    uploadRoute: 'opendxp_admin_dataobject_class_importfieldcollection',
    exportRoute: 'opendxp_admin_dataobject_class_exportfieldcollection',
    ...
    getRootPanel: function () {
        ...
        this.usagesStore = new Ext.data.ArrayStore({
            proxy: {
                url: Routing.generate('opendxp_admin_dataobject_class_getfieldcollectionusages'),
                type: 'ajax',
                reader: {
                    type: 'json'
                },
