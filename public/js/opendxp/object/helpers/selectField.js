...
opendxp.registerNS('opendxp.object.helpers.selectField');

/**
 * @private
 */
opendxp.object.helpers.selectField = {
        ...
        var selectOptionsSelector = Ext.create('Ext.form.field.ComboBox', {
            ...
            listeners: {
                change: function (comboBox, newValue) {
                    if (newValue !== null){
                        optionsProviderClass.setValue(opendxp.settings.select_options_provider_class);
