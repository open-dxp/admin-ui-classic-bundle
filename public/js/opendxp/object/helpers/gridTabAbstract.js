...
opendxp.registerNS("opendxp.object.helpers.gridTabAbstract");
/**
 * @private
 */
opendxp.object.helpers.gridTabAbstract = Class.create({
    ...
    openColumnConfig: function (allowPreview) {
        ...
        var dialog = new opendxp.object.helpers.gridConfigDialog(columnConfig, function (data, settings, save, context) {
    ...
    getToolbar: function (fromConfig, save) {
        if (!fromConfig) {
            ...
            this.toolbarFilterInfo = new Ext.Button({
                iconCls: "opendxp_icon_filter_condition",
                hidden: true,
                text: '<b>' + t("filter_active") + '</b>',
                tooltip: t("filter_condition"),
                handler: function (button) {
                    Ext.MessageBox.alert(t("filter_condition"), button.opendxp_filter_condition);
                }.bind(this)
            });

            this.clearFilterButton = new Ext.Button({
                iconCls: "opendxp_icon_clear_filters",
                hidden: true,
