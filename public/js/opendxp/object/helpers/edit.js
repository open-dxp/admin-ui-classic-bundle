...
opendxp.registerNS("opendxp.object.helpers.edit");
/**
 * @private
 */
opendxp.object.helpers.edit = {
    ...
    getRecursiveLayout: function (l, noteditable, context, skipLayoutChildren, onlyLayoutChildren, dataProvider, disableLazyRendering) {
        ...
        if (l.datatype == "layout") {
            ...
            if (opendxp.object.layout[l.fieldtype] !== undefined) {
                var layout = new opendxp.object.layout[l.fieldtype](l, context);
            ...
            if (opendxp.object.tags[l.fieldtype]) {
                var dLayout;
                var data;
                var metaData;
                ...
                if (context.containerType == 'localizedfield') {
                    if (l.mandatory && !in_array(context.language, opendxp.settings.requiredLanguages)) {
                        l.mandatory = false;
                        wasMandatory = true;
                    }
                }
                ...
                if (l.noteditable || noteditable) {
                    icons += '<span class="opendxp_object_label_icon opendxp_icon_gray_lock"></span>'
                }

                if(l.tooltip) {
                    icons += '<span class="opendxp_object_label_icon opendxp_icon_gray_info"></span>';
                }
                ...
                var field = new opendxp.object.tags[l.fieldtype](data, l);
