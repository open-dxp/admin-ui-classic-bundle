...
opendxp.registerNS("opendxp.object.classes.layout.text");
/**
 * @private
 */
opendxp.object.classes.layout.text = Class.create(opendxp.object.classes.layout.layout, {
                            ...
                            items: [
                                {
                                    ...
                                    width: 600,
                                    cls: 'opendxp_droptarget_display_edit',
                                    fieldBodyCls: 'opendxp_droptarget_display x-form-trigger-wrap',
                                    name: "previewObject",
                                    editable: true,
                                    listeners: {
                                        render: function (el) {
