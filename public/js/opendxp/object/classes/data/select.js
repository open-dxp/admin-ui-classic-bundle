...
opendxp.registerNS("opendxp.object.classes.data.select");
/**
 * @private
 */
opendxp.object.classes.data.select = Class.create(opendxp.object.classes.data.data, {
    ...
    getSpecificPanelItems: function (datax, inEncryptedField) {
        ...
        let appendedStylingItems = stylingItems.concat(
            opendxp.object.helpers.selectField.getOptionsProviderFields(datax, valueGrid)
        )
    ...
    showoptioneditor: function (valueStore) {
        var editor = new opendxp.object.helpers.optionEditor(valueStore);
        editor.edit();
    }
});
