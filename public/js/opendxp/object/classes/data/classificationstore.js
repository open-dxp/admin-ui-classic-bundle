...
opendxp.registerNS("opendxp.object.classes.data.classificationstore");
/**
 * @private
 */
opendxp.object.classes.data.classificationstore = Class.create(opendxp.object.classes.data.data, {
    ...
    getIconClass: function () {
        return "opendxp_icon_classificationstore";
    },
    ...
    getLayout: function ($super) {
        ...
        if (!this.isInCustomLayoutEditor()) {
            ...
            const store = new Ext.data.Store({
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_admin_dataobject_classificationstore_liststores')
                },
                autoDestroy: false,
                autoLoad: true,
                listeners: {
