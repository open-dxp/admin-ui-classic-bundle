...
opendxp.registerNS("opendxp.object.classes.data.table");
/**
 * @private
 */
opendxp.object.classes.data.table = Class.create(opendxp.object.classes.data.data, {
