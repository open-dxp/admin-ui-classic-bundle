...
opendxp.registerNS("opendxp.object.classes.data.countrymultiselect");
/**
 * @private
 */
opendxp.object.classes.data.countrymultiselect = Class.create(opendxp.object.classes.data.multiselect, {
    ...
    getIconClass: function () {
        return "opendxp_icon_countrymultiselect";
    },
    ...
    getSpecificPanelItems: function (datax, inEncryptedField) {
        ...
        const countryProxy = {
            type: 'ajax',
            url: Routing.generate('opendxp_admin_settings_getavailablecountries'),
            reader: {
                type: 'json',
                rootProperty: 'data'
            }
