...
opendxp.registerNS("opendxp.object.classes.data.fieldcollections");
/**
 * @private
 */
opendxp.object.classes.data.fieldcollections = Class.create(opendxp.object.classes.data.data, {
    ...
    getIconClass: function () {
        return "opendxp_icon_fieldcollection";
    },
    ...
    getLayout: function ($super) {
        ...
        this.store = new Ext.data.Store({
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_admin_dataobject_class_fieldcollectionlist'),
                reader: {
                    type: 'json',
