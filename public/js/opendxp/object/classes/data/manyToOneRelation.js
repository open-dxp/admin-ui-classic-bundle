...
opendxp.registerNS("opendxp.object.classes.data.manyToOneRelation");
/**
 * @private
 */
opendxp.object.classes.data.manyToOneRelation = Class.create(opendxp.object.classes.data.data, {
    ...
    initialize: function (treeNode, initData) {
        ...
        opendxp.helpers.sanitizeAllowedTypes(this.datax, "classes");
        opendxp.helpers.sanitizeAllowedTypes(this.datax, "assetTypes");
        opendxp.helpers.sanitizeAllowedTypes(this.datax, "documentTypes");
    ...
    getIconClass: function () {
        return "opendxp_icon_manyToOneRelation";
    },
    ...
    getLayout: function ($super) {
        ...
        if (this.isInCustomLayoutEditor()) {
            ...
            classesStore = new Ext.data.JsonStore({
                autoDestroy: true,
                proxy: {
                    type: 'ajax',
            ...
            documentTypeStore = new Ext.data.JsonStore({
                autoDestroy: true,
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_admin_dataobject_class_getdocumenttypes')
                },
                fields: ["text"]
            });
            ...
            assetTypeStore = new Ext.data.JsonStore({
                autoDestroy: true,
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_admin_dataobject_class_getassettypes')
                },
                fields: ["text"]
            });
            assetTypeStore.load({
