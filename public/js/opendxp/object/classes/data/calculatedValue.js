opendxp.registerNS("opendxp.object.classes.data.calculatedValue");
/**
 * @private
 */
opendxp.object.classes.data.calculatedValue = Class.create(opendxp.object.classes.data.data, {
    ...
    getIconClass: function () {
        return "opendxp_icon_calculatedValue";
    },
    ...
    getLayout: function ($super) {
        ...
        if (this.isInCustomLayoutEditor()) {
            ...
            const calculatorType = Ext.create('Ext.form.ComboBox', {
                ...
                value: this.datax.calculatorType ?? 'class'
            });
