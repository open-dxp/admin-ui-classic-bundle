...
opendxp.registerNS("opendxp.object.classes.data.password");
/**
 * @private
 */
opendxp.object.classes.data.password = Class.create(opendxp.object.classes.data.data, {
    ...
    getLayout: function ($super) {
        ...
        if(!this.isInCustomLayoutEditor()) {
            const algorithmsProxy = {
                type: 'ajax',
                url: Routing.generate('opendxp_admin_settings_getavailablealgorithms'),
                reader: {
                    type: 'json',
                    totalProperty: 'total',
