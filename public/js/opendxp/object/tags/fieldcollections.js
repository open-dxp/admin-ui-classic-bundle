...
opendxp.registerNS("opendxp.object.tags.fieldcollections");
/**
 * @private
 */
opendxp.object.tags.fieldcollections = Class.create(opendxp.object.tags.abstract, {
    ...
    initialize: function (data, fieldConfig) {
        ...
        document.addEventListener(opendxp.events.postSaveObject, this.postSaveObject.bind(this));
    ...
    getLayoutEdit: function () {
        ...
        this.component.on("destroy", function() {
            document.removeEventListener(opendxp.events.postSaveObject, this.postSaveObject.bind(this));
        }.bind(this));
    ...
    addBlockElement: function (index, config, blockData, ignoreChange) {
        ...
        var blockElement = new Ext.Panel({
            opendxp_oIndex: oIndex,
            cls: 'opendxp_fieldcollection_item',
        ...
        for(var s=0; s<this.component.items.items.length; s++) {
            ...
            if(this.currentElements[this.component.items.items[s].key]) {
                ...
                data.push({
                    type: element.type,
                    data: elementData,
                    oIndex: element.container.opendxp_oIndex
                });
            }
        }
...
opendxp.object.tags.fieldcollections.addMethods(opendxp.object.helpers.edit);
