...
opendxp.registerNS("opendxp.object.tags.video");
/**
 * @private
 */
opendxp.object.tags.video = Class.create(opendxp.object.tags.abstract, {
    ...
    getGridColumnConfig: function (field) {
        ...
        return {
            ...
            renderer: function (key, value, metaData, record) {
                ...
                if (value && value.id) {
                    var path = Routing.generate('opendxp_admin_asset_getvideothumbnail', {
                        id: value.id,
                        width: 88,
                        height: 88,
                        frame: true
    ...
    getLayoutEdit: function () {
        ...
        let bodyClass = "opendxp_video_container";

        if (allowedTypes.includes("asset")) {
            bodyClass = "opendxp_droptarget_image " + bodyClass;
        }
    ...
    getLayoutShow: function () {
        ...
        var conf = {
            ...
            bodyCls: "opendxp_video_container"
        };
    ...
    openEdit: function () {
        ...
        this.window = opendxp.helpers.editmode.openVideoEditPanel(this.data, {
    ...
    updateVideo: function () {
        ...
        if (this.data.type == "asset" && opendxp.settings.videoconverter) {
            var path = Routing.generate('opendxp_admin_asset_getvideothumbnail', {
                path: this.data.data,
                width: width,
                height: height,
