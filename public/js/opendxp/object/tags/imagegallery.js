...
opendxp.registerNS("opendxp.object.tags.imageGallery");
/**
 * @private
 */
opendxp.object.tags.imageGallery = Class.create(opendxp.object.tags.abstract, {
            ...
            renderer: function (key, value, metaData, record) {
                ...
                if(value && value.length > 0) {
                    ...
                    for(var i = 0; i < value.length; i++) {
                        ...
                        var route = 'opendxp_admin_asset_getimagethumbnail';
                        var params = {
                            width: 88,
                            height: 88,
                            frame: true,
    ...
    getFakeItems: function () {
        ...
        for (var i = 0; i < 15; i++) {
            ...
            var fieldConfig = this.getDefaultFieldConfig();
            var hotspotImage = new opendxp.object.tags.hotspotimage(data, fieldConfig, this.hotspotConfig);
    ...
    getImageGalleryPanel: function () {
        ...
        return new opendxp.object.helpers.ImageGalleryPanel({
            border: true,
            layout: {
                type: 'column',
                columns: 1
    ...
    getImageItems: function (fieldConfig) {
        ...
        for (let i = 0; i < this.data.length; i++) {
            ...
            let hotspotImage = new opendxp.object.tags.hotspotimage(itemData, fieldConfig, this.hotspotConfig);
            hotspotImage.updateContext(this.context);
            ...
            new Ext.dd.DropZone(el.getEl(), {
                ...
                onNodeDrop: function (target, dd, e, data) {
                    ...
                    data.records.forEach(function (record) {
                        ...
                        var hotspotImage = new opendxp.object.tags.hotspotimage(recordData, fieldConfig, objectField.hotspotConfig);
    ...
    add: function (me) {
        ...
        var hotspotImage = new opendxp.object.tags.hotspotimage({}, this.getDefaultFieldConfig(), this.hotspotConfig);
        hotspotImage.updateContext(this.context);
        var itemCount = this.component.items.length;
        var draggableComponent = this.wrap(hotspotImage);
    ...
    addDataFromSelector: function (item) {
        ...
        if (item) {
            this.markDirty();
            var hotspotImage = new opendxp.object.tags.hotspotimage({id: item.id}, this.getDefaultFieldConfig(), this.hotspotConfig);
            hotspotImage.updateContext(this.context);
            var itemCount = this.component.items.length;
            var draggableComponent = this.wrap(hotspotImage);
