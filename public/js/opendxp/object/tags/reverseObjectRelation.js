...
opendxp.registerNS("opendxp.object.tags.reverseObjectRelation");
/**
 * @private
 */
opendxp.object.tags.reverseObjectRelation = Class.create(opendxp.object.tags.manyToManyObjectRelation, {
    ...
    removeObject: function (index) {
        ...
        if (opendxp.globalmanager.exists("object_" + this.getStore().getAt(index).data.id) == false) {
            ...
            Ext.Ajax.request({
                ...
                success: function(index, response) {
                    ...
                    if (this.data.editlock) {
                        ...
                        Ext.Ajax.request({
                            url: Routing.generate('opendxp_admin_element_lockelement'),
                            method: 'PUT',
                            params: {
    ...
    getLayoutEdit: function () {
       ...
       this.component = new Ext.grid.GridPanel({
            ...
            cls: "opendxp_reverse-object-relation-panel",
            ...
            bbar: {
                items: [
                    {
                        xtype: "tbtext",
                        text:
                            ' <div class="warning opendxp_reverse-object-relation-warning">' +
                ...
                ctCls: "opendxp_force_auto_width",
                cls: "opendxp_force_auto_width opendxp_reverse-object-relation-bottom-bar",
                height: "4.5rem",
            },
    ...
    addObject: function(item) {
        ...
        if (opendxp.globalmanager.exists("object_" + item.id) == false) {
