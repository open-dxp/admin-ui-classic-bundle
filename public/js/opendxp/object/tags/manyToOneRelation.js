...
opendxp.registerNS("opendxp.object.tags.manyToOneRelation");
/**
 * @private
 */
opendxp.object.tags.manyToOneRelation = Class.create(opendxp.object.tags.abstract, {
    ...
    getLayoutEdit: function () {
        ...
        if (opendxp.helpers.hasSearchImplementation() && this.fieldConfig.displayMode === 'combo') {
            ...
            href.cls = 'opendxp_droptarget_display_edit';
            href.fieldBodyCls = 'opendxp_droptarget_display x-form-trigger-wrap';
        ...
        this.component.on("render", function (el) {
            ...
            el.getEl().on('dblclick', function () {
                ...
                opendxp.helpers.openElement(this.data.id, this.data.type, subtype);
            }.bind(this));
        }.bind(this));
    ...
    downloadAsset: function () {
        if (this.data.id && this.data.type && this.data.type === "asset") {
            if (this.data.subtype === "folder") {
                opendxp.elementservice.downloadAssetFolderAsZip(this.data.id)
            } else {
    ...
    requestNicePathData: function () {
        ...
        if (opendxp.helpers.hasSearchImplementation() && this.fieldConfig.displayMode === 'combo' && !this.fieldConfig.noteditable) {
