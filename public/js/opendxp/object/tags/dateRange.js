...
opendxp.registerNS('opendxp.object.tags.dateRange');
/**
 * @private
 */
opendxp.object.tags.dateRange = Class.create(opendxp.object.tags.abstract, {
    type: 'dateRange',
        ...
        return {
            ...
            renderer: function (key, value, metaData, record) {
                ...
                if (value) {
                    ...
                    const shortDateFormat = opendxp.globalmanager.get('localeDateTime').getShortDateFormat();
