...
opendxp.registerNS("opendxp.object.tags.image");
/**
 * @private
 */
opendxp.object.tags.image = Class.create(opendxp.object.tags.abstract, {
    ...
    uploadDialog: function () {
        opendxp.helpers.assetSingleUploadDialog(this.fieldConfig.uploadPath, "path", function (res) {
            try {
                this.empty(true);
    ...
    openImage: function () {
        if (this.data) {
            opendxp.helpers.openAsset(this.data.id, "image");
        }
    },
    ...
    updateImage: function () {
        if(this.data && this.data["id"]) {
            ...
            var path = Routing.generate('opendxp_admin_asset_getimagethumbnail', {
                id: this.data.id,
                width: width,
                height: height,
                contain: true
    ...
    getBody: function () {
        ...
        var elements = Ext.get(this.component.getEl().dom).query(".opendxp_image_container");
    ...
    onContextMenu: function (e) {
        ...
        if (this.data) {
            ...
            if (!this.fieldConfig.noteditable && this instanceof opendxp.object.tags.hotspotimage) {
                menu.add(new Ext.menu.Item({
        ...
        if(!this.fieldConfig.noteditable && opendxp.helpers.hasSearchImplementation()) {
            menu.add(new Ext.menu.Item({
                text: t('search'),
                iconCls: "opendxp_icon_search",
                handler: function (item) {
    ...
    empty: function () {
        ...
        body.addCls("opendxp_droptarget_image");
        this.dirty = true;
        body.repaint();
    },
