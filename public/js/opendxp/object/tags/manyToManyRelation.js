...
opendxp.registerNS("opendxp.object.tags.manyToManyRelation");
/**
 * @private
 */
opendxp.object.tags.manyToManyRelation = Class.create(opendxp.object.tags.abstractRelations, {
    ...
    getLayoutEdit: function () {
                            ...
                            if (data.data.id && data.data.type && data.data.type === "asset") {
                                if (data.data.id && data.data.type && data.data.type === "asset") {
                                    if (data.data.subtype === "folder") {
                                        opendxp.elementservice.downloadAssetFolderAsZip(data.data.id)
                                    } else {
        ...
        columns.push({
            ...
            items: [{
                ...
                handler: function (grid, rowIndex) {
                    ...
                    opendxp.helpers.deleteConfirm(t('relation'), data.data.fullpath, function () {
                        grid.getStore().removeAt(rowIndex);
                    }.bind(this));
                }.bind(this)
            }]
        ...
        this.component = new Ext.grid.GridPanel({
            ...
            bodyCssClass: "opendxp_object_tag_multihref",
            plugins: [
              'gridfilters'
            ]
        });
    ...
    requestNicePathData: function(targets) {
        ...
        opendxp.helpers.requestNicePathData(
            {
                type: "object",
                id: this.object.id
            },
