...
opendxp.registerNS("opendxp.object.tags.select");
/**
 * @private
 */
opendxp.object.tags.select = Class.create(opendxp.object.tags.abstract, {
    ...
    getGridColumnConfig:function (field) {
        if (field.layout.optionsProviderType !== opendxp.object.helpers.selectField.OPTIONS_PROVIDER_TYPE_CONFIGURE
            ...
            listeners: {
                focusenter: function(selectField, e) {
                    if (this.fieldConfig.dynamicOptions) {
                        Ext.Ajax.request({
                            url: Routing.generate('opendxp_admin_dataobject_dataobject_getSelectOptions'),
                            method: 'POST',
                            params: {
                            ...
                            success: function (response) {
                                ...
                                if (!(response && response.success)) {
                                    opendxp.helpers.showNotification(t("error"), t(response.message), "error", t(response.message));
                                } else {
                                    if (!this.fieldConfig.mandatory) {
