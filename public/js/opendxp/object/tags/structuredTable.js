...
opendxp.registerNS("opendxp.object.tags.structuredTable");
/**
 * @private
 */
opendxp.object.tags.structuredTable = Class.create(opendxp.object.tags.abstract, {
    ...
    getLayoutShow: function () {
        ...
        this.component = Ext.create('Ext.grid.Panel', {
            ...
            autoHeight: autoHeight,
            bodyCls: "opendxp_object_tag_objects"
        });
