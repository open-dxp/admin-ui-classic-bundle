...
opendxp.registerNS("opendxp.object.tags.externalImage");
/**
 * @private
 */
opendxp.object.tags.externalImage = Class.create(opendxp.object.tags.abstract, {
    ...
    getLayoutEdit: function () {
        ...
        var conf = {
            ...
            bodyCls: "opendxp_externalimage_container opendxp_image_container"
        };
    ...
    getBody: function () {
        ...
        var elements = Ext.get(this.component.getEl().dom).query(".opendxp_externalimage_container");
