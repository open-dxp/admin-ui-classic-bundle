...
opendxp.registerNS("opendxp.object.tags.table");
/**
 * @private
 */
opendxp.object.tags.table = Class.create(opendxp.object.tags.abstract, {
    ...
    initGrid: function () {
        ...
        if (!this.fieldConfig.noteditable)
        {
            ...
            if (!this.fieldConfig.colsFixed || columns.length < this.fieldConfig.cols) {
                tbar.push({
                    iconCls: "opendxp_icon_table_col opendxp_icon_overlay_add",
            ...
            if (!this.fieldConfig.colsFixed || columns.length > this.fieldConfig.cols) {
                tbar.push({
                    iconCls: "opendxp_icon_table_col opendxp_icon_overlay_delete",
            ...
            if (!this.fieldConfig.rowsFixed || data.length != this.fieldConfig.rows) {
                ...
                tbar.push({
                    iconCls: "opendxp_icon_table_row opendxp_icon_overlay_delete",
                    handler: this.deleteRow.bind(this)
                });

                tbar.push({
                    iconCls: "opendxp_icon_table_row opendxp_icon_overlay_clone",
