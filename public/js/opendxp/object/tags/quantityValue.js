...
opendxp.registerNS("opendxp.object.tags.quantityValue");
/**
 * @private
 */
opendxp.object.tags.quantityValue = Class.create(opendxp.object.tags.abstract, {
    ...
    finishSetup: function() {
        ...
        opendxp.helpers.quantityValue.initUnitStore(this.setData.bind(this), this.fieldConfig.validUnits, this.data);
    },
    ...
    getLayoutEdit: function () {
        ...
        var compatibleUnitsButton = Ext.create('Ext.Button', {
            iconCls: "opendxp_icon_calculatedValue",
        ...
        var updateCompatibleUnitsToolTipContent = function() {
            if(opendxp.globalmanager.get("user").isAllowed('quantityValueUnits') !== true) {
            ...
            Ext.Ajax.request({
                url: Routing.generate('opendxp_admin_dataobject_quantityvalue_convertall'),
                params: {
            ...
            listeners: {
                change: function( combo, newValue, oldValue) {
                    if(this.fieldConfig.autoConvert && (oldValue !== '' || oldValue !== null) && (newValue !== '' && newValue !== null)) {
                        Ext.Ajax.request({
                            url: Routing.generate('opendxp_admin_dataobject_quantityvalue_convert'),
                            params: {
                                value: this.inputField.value,
                                fromUnit: oldValue,
                                toUnit: newValue
    ...
    getGridColumnFilter: function (field) {
            ...
            Ext.define('Ext.grid.filters.filter.QuantityValue', {
                ...
                createMenu: function () {
                    ...
                    var cfg = {
                        xtype: 'combo',
                        name: 'unit',
                        labelClsExtra: Ext.baseCSSPrefix + 'grid-filters-icon opendxp_nav_icon_quantityValue',
                        queryMode: 'local',
                        editable: false,
                        forceSelection: true,
        ...
        opendxp.helpers.quantityValue.initUnitStore(function(data) {
