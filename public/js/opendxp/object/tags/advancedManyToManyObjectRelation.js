...
opendxp.registerNS("opendxp.object.tags.advancedManyToManyObjectRelation");
/**
 * @private
 */
opendxp.object.tags.advancedManyToManyObjectRelation = Class.create(opendxp.object.tags.manyToManyObjectRelation, {
    ...
    createLayout: function (readOnly) {
        ...
        for (let i = 0; i < visibleFields.length; i++) {
            if (!empty(this.fieldConfig.visibleFieldDefinitions) && !empty(visibleFields[i])) {
                ...
                let fc = opendxp.object.tags[layout.fieldtype].prototype.getGridColumnConfig(field);
    ...
    getGridColumnConfig: function (field) {
        return {
            ...
            renderer: opendxp.object.helpers.grid.prototype.advancedRelationGridRenderer.bind(this, field, "fullpath")
        };
    },
