...
opendxp.registerNS("opendxp.object.gridcolumn.operator.concatenator");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.concatenator = Class.create(opendxp.object.gridcolumn.operator.text, {
    operatorGroup: "transformer",
    type: "operator",
    class: "Concatenator",
    iconCls: "opendxp_icon_operator_concatenator",
