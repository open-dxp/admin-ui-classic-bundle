...
opendxp.registerNS("opendxp.object.gridcolumn.operator.requiredby");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.requiredby = Class.create(opendxp.object.gridcolumn.Abstract, {
    operatorGroup: "extractor",
    type: "operator",
    class: "RequiredBy",
    iconCls: "opendxp_icon_operator_requiredby",
    ...
    getNodeLabel: function(configAttributes) {
        ...
        if (configAttributes.elementType) {
            nodeLabel += '<span class="opendxp_gridnode_hint"> (' + configAttributes.elementType  + ')</span>';
        }
