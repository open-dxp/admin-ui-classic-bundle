...
opendxp.registerNS("opendxp.object.gridcolumn.operator.fieldcollectiongetter");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.fieldcollectiongetter = Class.create(opendxp.object.gridcolumn.Abstract, {
    ...
    getNodeLabel: function (configAttributes) {
        ...
        if (configAttributes.attr) {
            nodeLabel += '<span class="opendxp_gridnode_hint"> (' + configAttributes.attr + "-" + configAttributes.idx + "-" + configAttributes.colAttr + ')</span>';
        }
