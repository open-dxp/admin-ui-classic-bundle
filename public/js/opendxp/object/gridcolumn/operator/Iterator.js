...
opendxp.registerNS("opendxp.object.gridcolumn.operator.iterator");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.iterator = Class.create(opendxp.object.gridcolumn.operator.text, {
    operatorGroup: "transformer",
    type: "operator",
    class: "Iterator",
    iconCls: "opendxp_icon_operator_iterator",
