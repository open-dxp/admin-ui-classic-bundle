...
opendxp.registerNS("opendxp.object.gridcolumn.operator.stringreplace");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.stringreplace = Class.create(opendxp.object.gridcolumn.Abstract, {
    operatorGroup: "transformer",
    type: "operator",
    class: "StringReplace",
    iconCls: "opendxp_icon_operator_stringreplace",
