...
opendxp.registerNS("opendxp.object.gridcolumn.operator.trimmer");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.trimmer = Class.create(opendxp.object.gridcolumn.operator.text, {
    operatorGroup: "transformer",
    type: "operator",
    class: "Trimmer",
    iconCls: "opendxp_icon_operator_trimmer",
    defaultText: "Trimmer",
    group: "string",
