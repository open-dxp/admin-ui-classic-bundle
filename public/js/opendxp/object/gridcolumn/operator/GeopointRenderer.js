...
opendxp.registerNS("opendxp.object.gridcolumn.operator.geopointrenderer");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.geopointrenderer = Class.create(opendxp.object.gridcolumn.Abstract, {
    operatorGroup: "renderer",
    type: "operator",
    class: "GeopointRenderer",
    iconCls: "opendxp_icon_geopoint",
