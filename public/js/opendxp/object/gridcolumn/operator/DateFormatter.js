...
opendxp.registerNS("opendxp.object.gridcolumn.operator.dateformatter");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.dateformatter = Class.create(opendxp.object.gridcolumn.Abstract, {

    operatorGroup: "formatter",
    type: "operator",
    class: "DateFormatter",
    iconCls: "opendxp_icon_datetime",
    ...
    getNodeLabel: function (configAttributes) {
        ...
        if (configAttributes.format) {
            nodeLabel += '<span class="opendxp_gridnode_hint"> (' + configAttributes.format + ')</span>';
        }
