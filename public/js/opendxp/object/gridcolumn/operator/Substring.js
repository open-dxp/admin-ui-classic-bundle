...
opendxp.registerNS("opendxp.object.gridcolumn.operator.substring");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.substring = Class.create(opendxp.object.gridcolumn.Abstract, {
    operatorGroup: "transformer",
    type: "operator",
    class: "Substring",
    iconCls: "opendxp_icon_operator_substring",
