...
opendxp.registerNS("opendxp.object.gridcolumn.operator.anygetter");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.anygetter = Class.create(opendxp.object.gridcolumn.Abstract, {
        ...
        getNodeLabel: function (configAttributes) {
            ...
            if (configAttributes.attribute) {
                ...
                nodeLabel += '<span class="opendxp_gridnode_hint"> (' + Ext.util.Format.htmlEncode(attr) + ')</span>';
            }
