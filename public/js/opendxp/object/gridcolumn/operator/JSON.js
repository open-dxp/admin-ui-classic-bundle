...
opendxp.registerNS("opendxp.object.gridcolumn.operator.json");
/**
 * @private
 */
opendxp.object.gridcolumn.operator.json = Class.create(opendxp.object.gridcolumn.operator.text, {
    operatorGroup: "transformer",
    type: "operator",
    class: "JSON",
    iconCls: "opendxp_icon_operator_json",
    defaultText: "JSON",
    group: "other",
