...
opendxp.registerNS('opendxp.object.selectoptionsitems.definition');

/**
 * @private
 */
opendxp.object.selectoptionsitems.definition = Class.create({
    parentPanel: null,
    data: {
        id: null,
        enumName: null,
    ...
    createUsagesStore: function () {
        this.usagesStore = Ext.create('Ext.data.ArrayStore', {
            proxy: {
                url: Routing.generate('opendxp_admin_dataobject_class_getselectoptionsusages'),
                type: 'ajax',
                reader: {
                    type: 'json'
                },
