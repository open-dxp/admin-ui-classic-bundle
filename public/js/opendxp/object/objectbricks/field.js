...
opendxp.registerNS("opendxp.object.objectbricks.field");
/**
 * @private
 */
opendxp.object.objectbricks.field = Class.create(opendxp.object.classes.klass, {
    ...
    uploadRoute: 'opendxp_admin_dataobject_class_importobjectbrick',
    exportRoute: "opendxp_admin_dataobject_class_exportobjectbrick",
    context: "objectbrick",
    baseStore: {},
    classStores: {},
    availableClasses: {},
    ...
    initClassData: function () {
        var objectTypeStore = opendxp.globalmanager.get("object_types_store");
    ...
    saveOnComplete: function (reload, response) {
        ...
        if (rdata && rdata.success) {
            ...
            if (rdata && rdata.message) {
                opendxp.helpers.showNotification(t("error"), rdata.message, "error");
            } else {
